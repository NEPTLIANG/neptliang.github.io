---
layout:       post
title:        "Wappalyzer指纹配置"
subtitle:     "null"
date:         2021-01-11 14:29:54
author:       "NeptLiang"
...
[原来的配置（github.com/AliasIO/wappalyzer/blob/master/src/technologies.json）](https://github.com/AliasIO/wappalyzer/blob/master/src/technologies.json)的`categories`属性下是68个技术（也就是指纹）分类，为数值id；`technologies`属性下是1502种技术的具体信息及其所属的分类id，以技术名为key

阅读时虽然可以按技术名首字母顺序查找，但是在1.5k种技术里翻找也不容易，所以按分类整理一下，以分类名为key，把同类型的技术合在同一个类型key里，在VS Code里看起来方便点，毕竟可以折叠

```js
/**
 * 整理配置
 * @param {object} conf 官方配置
 */
const process = (conf) => {
    processed = {}
    for (let techName in conf.technologies) {
        //console.log(conf.technologies[techName].cats.length.max)
        for (cat of conf.technologies[techName].cats) {
            processed[conf.categories[cat].name] ? null : processed[conf.categories[cat].name] = {}
            processed[conf.categories[cat].name][techName] = conf.technologies[techName]
            //console.log(cat)
        }
    }
    return processed
...
共计68个分类，1502种技术，440906字符，23652行。整理好后如下：
...
```json
{
    ...
    "Ecommerce": {
        ...
        "91App": {
            ...
            "icon": "91app.png",
            "scripts": "https\\:\\/\\/track\\.91app\\.io\\/track\\.js\\?",
        ...
        "Miresoone": {
            ...
            "description": "Miresoone is an online ordering site builder.",
            "icon": "Miresoone.svg",
            "implies": [
                "Laravel",
                "React"
        ...
        "Tebex": {
            ...
            "icon": "Tebex.png",
            "scripts": "https://server\\.tebex\\.io/tebexAccounts/tebexaccounts\\.js",
    ...
    "Analytics": {
        ...
        "New Relic": {
            ...
            "description": "New Relic is a Software-as-a-Service offering that focuses on performance and availability monitoring.",
            "icon": "New Relic.svg",
            "js": {
                "NREUM": "",
                "newrelic": ""
        ...
        "Simple Analytics": {
            ...
            "scripts": "^https:\\/\\/cdn\\.simpleanalytics\\.io\\/hello\\.js",
        ...
        "VWO": {
            ...
            "description": "VWO is a website testing and conversion optimization platform.",
            "icon": "VWO.svg",
            "js": {
                "VWO": "",
                "__vwo": ""
    ...
    "Widgets": {
        ...
        "Linkedin": {
            ...
            "icon": "Linkedin.svg",
            "scripts": "//platform\\.linkedin\\.com/in\\.js",
    ...
    "Web servers": {
        ...
        "Logitech Media Server": {
            ...
            "description": "Logitech Media Server is a streaming audio server.",
            "headers": {
    ...
    "Marketing automation": {
        "Act-On": {
            ...
            "description": "Act-On is a Software-as-a-Service (SaaS) product for marketing automation.",
            "icon": "ActOn.png",
            "js": {
                "ActOn": ""
            },
        ...
        "Infusionsoft": {
            ...
            "description": "Infusionsoft is a cloud-based email marketing platform and customer relationship management (CRM) system.",
            "html": [
        ...
        "Listrak": {
            ...
            "description": "Listrak is a AI-based marketing automation and CRM solutions that unify, interpret and personalize data to engage customer across channels and devices.",
            "icon": "Listrak.png",
            "js": {
                "_LTKSignup": "",
                "_LTKSubscriber": ""
    ...
    "Advertising": {
        ...
        "Criteo": {
            ...
            "description": "Criteo provides personalized retargeting that works with Internet retailers to serve personalized online display advertisements to consumers who have previously visited the advertiser's website.",
            "icon": "Criteo.svg",
            "js": {
                "Criteo": "",
                "criteo_pubtag": "",
    ...
    "Payment processors": {
        ...
        "SplitIt": {
            ...
            "description": "Splitit is the only buy-now-pay-later plan that lets shoppers set up payment plans with their existing credit card without interest charges or fees.",
            "icon": "splitit.png",
            "scripts": "checkout\\.production\\.splitit\\.com",
    ...
    "Social logins": {
        ...
        "Facebook Sign-in": {
            ...
            "description": "FaceBook sign-in allows uses to create an account or log into Facebook. Connect with friends, family and other people you know. Share photos and videos, send messages and get updates.",
            "icon": "Facebook.svg",
            "js": {
                "FB.getLoginStatus": ""
            },
    ...
    "Maps": {
        ...
        "HERE": {
            ...
            "description": "HERE provides mapping and location data to individuals and companies.",
            "icon": "HERE.png",
            "scripts": "https?://js\\.cit\\.api\\.here\\.com/se/([\\d.]+)\\/\\;version:\\1",
    ...
    "Static site generator": {
        ...
        "Jekyll": {
            ...
            "description": "Jekyll is a blog-aware, static site generator for personal, project, or organization sites.",
            "html": [
    ...
    "LMS": {
        ...
        "Scholica": {
            ...
            "description": "Scholica is a Virtual Learning Platform (VLP).",
            "headers": {
                "X-Scholica-Version": ""
            },
            "icon": "Scholica.svg",
    ...
    "Cryptominers": {
        ...
        "Webmine": {
            ...
            "description": "Webmine is a cryptocurrency mining service.",
    ...
    "Media servers": {
        ...
        "Wowza Media Server": {
            ...
            "description": "Wowza is a live video streaming platform.",
...
* [github.com/AliasIO/wappalyzer/blob/master/src/technologies.json](https://github.com/AliasIO/wappalyzer/blob/master/src/technologies.json)
